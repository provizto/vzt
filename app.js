...
async function disconnectWallet() {
    ...
    try {
        ...
        // SET STATUS KONEKSI GLOBAL KEMBALI KE FALSE BEFORE RESET BUTTONS
        isConnected = false;
        isTokenLocked = false;
        activeProvider = null;

        // PERBAIKAN TOTAL: Kunci kembali dan redupkan visual tombol dApp ke mode abu-abu default
        actionButtons.forEach(b => {
            b.setAttribute('disabled', 'true');
            b.style.pointerEvents = "none";  // Mematikan sensor hover/klik
            b.style.cursor = "not-allowed";  // Mengubah kursor jadi lambang dilarang
            b.style.background = "#1f2937";   // Kembali ke warna abu-abu gelap default CSS lama
            b.style.color = "#94a3b8";       // Teks kembali redup
            
            // Khusus tombol Lock Token, reset teks aslinya jika sebelumnya sukses melock
            if (b.id === 'lockBtn') {
                b.innerText = 'Lock Token';
            }
        });
        ...
        // Reset skor dan hitungan internal kalkulator di antarmuka web
