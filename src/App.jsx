...
function App() {
  ...
  // ==========================================================================
  const tokens = [
    { symbol: 'USDC', name: 'USD Coin', priceInUsdc: 1 },
    { symbol: 'USDT', name: 'Tether', priceInUsdc: 1 },
    { symbol: 'SOL', name: 'Solana', priceInUsdc: 170 },
    { symbol: 'WSOL', name: 'Wrapped Solana', priceInUsdc: 170 },
    { symbol: 'VZT', name: 'Provizto Token', priceInUsdc: 0.5 }
  ];
  ...
  const handleLaunchSwap = async () => {
    ...
    setTxLog('Routing private transaction bundle via Jito Engine (MEV Protection)...');
